...
<div class="component">
    ...
    <form
        action="<?php echo JRoute::_("index.php?option=com_zeitbank&task=stundengeschenk.save&Itemid=" . $this->menuId); ?>"
    ...
    <div style="margin-top:15px">
        ...
        <ul>
            ...
            <li>Der/die EmpfängerIn kann Stunden nur bis zur Erreichung des Stundensolls empfangen -
                <strong>Ausnahme:</strong> Keine Prüfung bei Gewerbe.
            </li>
