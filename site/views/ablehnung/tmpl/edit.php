...
<div class="component">
	...
	<form action="<?php echo JRoute::_("index.php?option=com_zeitbank&task=ablehnung.save&Itemid=".$this->menuId); ?>" 
	  ...
	  <table class="zb_form">
			<tr>
			  ...
			  <td class="value"><?php echo $this->form->getInput('kommentar_ablehnung'); ?><br/>(max. 1000 Zeichen)</td>
			</tr>
    </table>			  
  ...
  <div style="margin-top:15px">
    ...
    <ul>
      ...
      <li>Der Antrag bleibt auch nach der Ablehnung bestehen, bis der/die AntragstellerIn den Antrag gelöscht oder bearbeitet hat.</li>
      <li>Du kannst bei fehlerhaften Anträgen auch weiterhin direkt Kontakt zum/zur AntragstellerIn aufnehmen, ohne den Antrag vorgängig ablehnen zu müssen.</li>
    </ul>
  </div>
