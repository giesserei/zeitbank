...
<div class="component">
    ...
    <ul>
        ...
        <li>Buchungsantrag an <strong><?php echo $this->antrag->konto_belastung; ?></strong> über
            <strong><?php echo $this->antrag->minuten; ?></strong> Minuten
        </li>
    ...
    <form
        action="<?php echo JRoute::_("index.php?option=com_zeitbank&task=antragloeschen.delete&Itemid=" . $this->menuId); ?>"
