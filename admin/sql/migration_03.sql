-- View, welche alle aktiven Mitglieder (Bewohner + Gewerbe) inkl. Siedlungsassistenz selektiert
...
CREATE VIEW joomghjos_mgh_aktiv_mitglied AS
  ...
  WHERE m.typ IN (1,2,5) AND (m.austritt = '0000-00-00' OR m.austritt > NOW())